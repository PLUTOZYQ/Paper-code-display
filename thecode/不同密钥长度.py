...
def compare_aggregation_methods_viz_key_length():
    ...
    plt.plot(key_length_list, traditional_times, 'o-', label='traditional') 
    plt.plot(key_length_list, reduce_times, '^-', label='reduce')
    plt.plot(key_length_list, optimized_times, 's-', label='Our scheme')
